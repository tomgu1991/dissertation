...
以及开发者确认并且修复的缺陷报告个数。
表中数据显示，Tsmart-IMChecker工具共在17个项目中发现75个实际接口误用缺陷。
...
Tsmart-IMChecker工具共发现30个未被报告的接口缺陷。
...
\begin{figure}[b]
	\centering
	\begin{lstlisting}
"summary": "fix setting of 'ret' error return for a few cases",
"date": "2018-08-162018-08-16",
"author": "Jens Axboe",
